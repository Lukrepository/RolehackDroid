...
const struct Role roles[NUM_ROLES+1] = {
    { { "Archeologist", 0 },
      ...
      SPE_MAGIC_MAPPING,
      -4 },
    /* NB: must stay adjacent to Archeologist -- setup_rolemenu() only
       compares each role's initial against the immediately preceding
       one, so 'A'pothecary vs 'a'rcheologist is resolved by adjacency,
       exactly as Rogue/Ranger are */
    { { "Apothecary", 0 },
      { { "Pestler", 0 },
        { "Herbalist", 0 },
        { "Decoctor", 0 },
        ...
        { "Spagyrist", 0 },
        { "Philosopher", 0 } },
      "Ninazu", "_Gula", "Nergal", /* Mesopotamian */
      "Apo",
      "the Royal Mint",
      "the Newgate Warrens",
      PM_APOTHECARY,
