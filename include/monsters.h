...
#define SEDUCTION_ATTACKS_NO \
    ...
    MON(NAM("Sir Isaac Newton"), S_HUMAN,
        LVL(20, 12, 0, 90, 0), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 4, 10), ATTK(AT_MAGC, AD_SPEL, 2, 8),
          ATTK(AT_MAGC, AD_SPEL, 2, 8), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_LEADER, MZ_HUMAN), MR_POISON, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_MALE | M2_PNAME | M2_PEACEFUL | M2_STRONG
            | M2_COLLECT | M2_MAGIC, M3_CLOSE | M3_INFRAVISIBLE,
        25, HI_LORD, SIR_ISAAC_NEWTON),
    /*
     * quest nemeses
     */
    ...
    MON(NAM("William Chaloner"), S_HUMAN,
        LVL(15, 12, 0, 40, -10), (G_NOGEN | G_UNIQ | G_NOCORPSE),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), ATTK(AT_WEAP, AD_PHYS, 2, 6),
          ATTK(AT_CLAW, AD_SAMU, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_NEMESIS, MZ_HUMAN), MR_STONE, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_MALE | M2_PNAME | M2_HOSTILE | M2_STALK
            | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_COLLECT,
        M3_WANTSARTI | M3_WAITFORU | M3_INFRAVISIBLE,
        19, HI_LORD, WILLIAM_CHALONER),
    /*
     * quest "guardians"
     */
    MON(NAM("assayer"), S_HUMAN,
        ...
        M2_NOPOLY | M2_HUMAN | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE,
        12, HI_DOMESTIC, ASSAYER),
    MON(NAM("bribed constable"), S_HUMAN,
        LVL(6, 10, 10, 0, -4), (G_SGROUP | G_NOGEN | G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SOLDIER, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_HOSTILE | M2_STALK | M2_GREEDY
            | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE,
        8, CLR_BLUE, BRIBED_CONSTABLE),
